          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 4:
                ...
                _context.next = 12;
                return axios__WEBPACK_IMPORTED_MODULE_3___default.a.post(register_route, data).then(function (response) {
              ...
              case 12:
                ...
                _context.next = 16;
                return document.getElementById('kt_login_signup_submit').click();
  ...
  created: function created() {
    this.$validator.extend('unique', {
      ...
      validate: function () {
        ...
        /*#__PURE__*/
        _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2(value, arg) {
          var sw, data;
            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  ...
                  _context2.next = 5;
                  return axios__WEBPACK_IMPORTED_MODULE_3___default.a.post(check_signup_route, data, {
                    headers: {
...
var forget = new vue__WEBPACK_IMPORTED_MODULE_1___default.a({
  el: '#forget',
  data: {
    sending_code: false,
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 3:
                ...
                mobile = document.getElementsByName('mobile_forget')[0].value;
                _context3.next = 11;
                return axios__WEBPACK_IMPORTED_MODULE_3___default.a.post(sendcode_route, data).then(function (response) {
                  if (response.status == 200) {
                    sw = true;
                  }
                })["catch"](function (error) {
                  console.log(error);
                  _this2.sending_code = false;
                });
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _context4.next = 8;
                return axios__WEBPACK_IMPORTED_MODULE_3___default.a.post(confirm_code_route, data).then(function (response) {
                  if (response.data == true) {
                    sw = true;
                  }
                })["catch"](function (error) {
              ...
              case 8:
                if (sw) {
                  ...
                  setTimeout(function () {
                    ...
                    _this3.sending_code = false;
                    _this3.show_verify_button = false;
                    _this3.not_confirmed = false;
                  }, 6000);
                } else {
  ...
  created: function created() {
    this.$validator.extend('mobexist', {
      validate: function () {
        var _validate4 = _asyncToGenerator(
        /*#__PURE__*/
            ...
            while (1) {
              switch (_context5.prev = _context5.next) {
                case 0:
                  ...
                  _context5.next = 4;
                  return axios__WEBPACK_IMPORTED_MODULE_3___default.a.post(mobexist_route, data, {
                    headers: {
                      'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
                    }
                  }).then(function (response) {
...
var signin = new vue__WEBPACK_IMPORTED_MODULE_1___default.a({
  el: '#signin',
  data: {
    checking: false
  },
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                _context6.next = 4;
                return axios__WEBPACK_IMPORTED_MODULE_3___default.a.post(sign_route, data).then(function (response) {
                  if (response.data == true) {
                    console.log('responsed true');
                    document.getElementById('kt_login_signin_submited').click();
                    _this4.checking = false;
...
module.exports = __webpack_require__(/*! C:\Users\Mehdi\Desktop\factor\resources\js\login.js */"./resources/js/login.js");
